...
- [ ] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
  It is a UI library that is unopioniated in terms of what you can use it with. It utilized a virtual DOM to reduce the performance need of constantly having to instead update the whole DOM with changes to state.

- [ ] What does it mean to _think_ in react?
  To think in terms of component hierarchy and use interchangeably components to achieve functionality.

- [ ] Describe state.
  State is essentially a rendered version of an object and applies to class components

- [ ] Describe props.
Props are what get passed down in class or functionaly components
